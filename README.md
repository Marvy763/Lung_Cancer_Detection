...
this is Graduation Project of Lung Cancer Detection with accuracy of 98.5%


About DataSet
- total images: 1000
* IMPORTANT NOTE: the valid folder images copied to test folder to avoid overfitting in dataset
